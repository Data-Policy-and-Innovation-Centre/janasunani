...
Put one slide or terminal output on screen. The canonical artifact is `outputs/benchmark/table2.md` (and `table2.json`) generated by the benchmark harness (see [`docs/plans/2026-08-08-demo-integration-rehearsal.md` Part 5](plans/2026-08-08-demo-integration-rehearsal.md#part-5--benchmark-scores-speed-cost-and-pipeline-switching)). If the generator has not landed on this branch, walk the same numbers from the sources below — do not fabricate a table.

### Table 2 — what to show (DSI reference vs our measurement)
