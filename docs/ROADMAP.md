...
| 16 | II | **A/B instrumentation + retrospective impact evidence** *(d)* | 🔄 *(SSEPD and Labour & ESI approved a bounded pilot, 01 Sep. Rescoped 02 Sep to descriptive work delivered by December: desk study, process maps, one field trip, hand-answered officer questions and a measured pipeline evaluation. Randomisation deferred out of 2026 for want of an engineer, API access and measured officer throughput. See AB_PLAN §14.9 and [PILOT_SSEPD_LABOUR.md](PILOT_SSEPD_LABOUR.md))* |
