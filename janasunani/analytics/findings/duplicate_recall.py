...
def render_markdown(tables: dict[str, pl.DataFrame]) -> str:
    ...
    lines = [
        ...
        "",
        "**Insight.** No model: prefix-anchored normalized match over action remarks officers already wrote.",
        "",
        ...
        " The delta is upward because the ROADMAP figures came from an ad hoc exact-match",
        " query, while these templates are stored with a suffix and often a referenced ticket",
        " number ('duplicate copy of DEPT2024669445'). Prefix matching keeps those; exact",
